...
const Home = () => {
  ...
  return (
    <>
      <div className="container mx-auto px-4 py-8 mt-24 flex justify-between p-4 border border-gray-200 bg-white">
        {infoItems.map((item, index) => (
          <div
            key={index}
            className="flex items-center border-r border-gray-200 px-6 py-2 last:border-r-0"
          >
